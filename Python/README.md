...
Accessing elements of a string, or sequence, using [start : end : step] (indexing operator).
...
3. Step: The step index is optional and determines the increment between each index for slicing

To print a range you can do a variety of things:
- 

To print a range you use a colon and the ending index.
